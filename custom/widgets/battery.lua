...
--local WIDGET_DIR = HOME .. '/.config/awesome/themes/custom/widgets/battery-widget'

local battery_widget = {}
local function worker(user_args)
    local args = user_args or {}

    local font = args.font or 'Terminus 12'
    local path_to_icons = args.path_to_icons or "/usr/share/icons/Adwaita/symbolic/legacy/" --"/usr/share/icons/Arc/status/symbolic/"
    ...
    local warning_msg_title = args.warning_msg_title or 'Warning'
    ...
    function(widget, stdout)
        ...
        if show_current_level then
            level_widget.markup = string.format('<b>%d%%</b>', charge)
        end
