...
local function worker(user_args)
    ...
    local color_used = args.color_used or beautiful.fg_focus
    local color_free = args.color_free or beautiful.bg_urgent -- beautiful.fg_normal
    local color_buf  = args.color_buf  or "#0000FF" --beautiful.border_color_active
    ...
    local popup = awful.popup{
       ...
       border_color = "#ffffff", --beautiful.border_color_active,
       border_width = 1,
       offset = { y = 5 },
    }
