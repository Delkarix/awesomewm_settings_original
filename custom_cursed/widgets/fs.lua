...
config.widget_bar_color = '#ffffff'
config.widget_onclick_bg = '#ff0000'
config.widget_border_color = "#ffffff"
config.widget_background_color = '#000000'

-- popup
config.popup_bg = '#000000'
config.popup_border_width = 1
config.popup_border_color = "#ffffff"
config.popup_bar_color = '#ffffff'
config.popup_bar_background_color = '#000000'
config.popup_bar_border_color = "#ffffff"
...
local function worker(user_args)
    ...
    storage_bar_widget = wibox.widget {
        ...
        shape = gears.shape.rectangle, --function(cr, width, height)
    ...
    local popup = awful.popup {
        ...
        ontop = true,
        visible = false,
        shape = gears.shape.rectangle, --gears.shape.rounded_rect,
    ...
    storage_bar_widget:connect_signal("mouse::leave", function()
	popup.visible = false
	storage_bar_widget:set_bg("#00000000")
    end)
